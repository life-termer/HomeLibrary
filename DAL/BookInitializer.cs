   ...
   /* Code causes a database to be created when needed and loads test data into the new database.*/
    public class BookInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<BookContext>
    {
        ...
        protected override void Seed(BookContext context)
        {
            ...
            {
                new Book{Title="Harry Potter and the Sorcerer's Stone",Author="J.K. Rowling",Genre="fantasy",Type=Models.Type.Hardcover,
                ...
                new Book{Title="Harry Potter and the Chamber of Secrets",Author="J.K. Rowling",Genre="fantasy",Type=Models.Type.Hardcover,
                ...
                new Book{Title="Harry Potter and the Prisoner of Azkaban",Author="J.K. Rowling",Genre="fantasy",Type=Models.Type.Hardcover,
                ...
                new Book{Title="Harry Potter and the Goblet of Fire",Author="J.K. Rowling",Genre="fantasy",Type=Models.Type.Hardcover,
                ...
                new Book{Title="Harry Potter and the Order of the Phoenix",Author="J.K. Rowling",Genre="fantasy",Type=Models.Type.Paperback,
                ...
                new Book{Title="Harry Potter and the Half-Blood Prince",Author="J.K. Rowling",Genre="fantasy",Type=Models.Type.Hardcover,
                ...
                new Book{Title="Harry Potter and the Deathly Hallowse",Author="J.K. Rowling",Genre="fantasy",Type=Models.Type.Hardcover,
                ...
                new Book{Title="The Lord of the Rings: 50th Anniversary, One Vol. Edition",Author="J.R.R. Tolkien",Genre="fantasy",Type=Models.Type.Hardcover,
